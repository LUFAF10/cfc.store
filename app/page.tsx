      ...
      <AnimatePresence mode="wait">
        ...
        {currentView === "home" && (
          <motion.main
            ...
            animate="animate"
            exit="exit"
            className="flex flex-col items-center min-h-screen px-6 text-center bg-stadium-black pt-40 pb-20"
          >
            <div className="max-w-3xl mx-auto flex flex-col items-center">
              ...
              <motion.h1
                ...
                className="text-5xl md:text-7xl font-black tracking-tight leading-none text-cream-bone uppercase font-display text-center mb-10"
              >
        ...
        {currentView === "categories" && (
          <motion.main
            ...
            animate="animate"
            exit="exit"
            className="flex flex-col min-h-screen bg-stadium-black px-6 pt-32 pb-20"
          >
            <div className="max-w-2xl mx-auto w-full flex flex-col flex-1">

              <button
                onClick={() => setCurrentView("home")}
                className="self-start text-cream-bone/40 hover:text-cream-bone text-xs tracking-widest uppercase font-light transition-colors duration-200 flex items-center gap-2 mb-16"
              >
                ← Volver
              </button>
                ...
                {CATEGORY_LIST.map(({ label, key }, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span
                          className={`font-display font-black uppercase text-4xl md:text-5xl tracking-tight transition-colors duration-200 ${
                            available
